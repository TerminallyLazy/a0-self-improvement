...
Autopilot does not manufacture its own authority. Version 2.0.10 automates safe collection and candidate scheduling, but production automatic canary/activation remains blocked because no production transition runner or production-scoped Policy Calibration Artifact ships with the plugin. The dashboard reports these as explicit blocked gates. That boundary is intentional: workers can propose changes, but they cannot promote themselves.
